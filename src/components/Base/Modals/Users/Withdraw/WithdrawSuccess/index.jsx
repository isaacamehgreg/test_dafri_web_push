...
// images
import modalCover from '../../../../../../styles/img/modal-cover1.svg';
import modalStatus from '../../../../../../styles/img/modal-status1.svg';
import routes from '../../../../../../routes';

const WithdrawSuccess = ({ amount, address, assetCode }) => {
  return (
      ...
      <div className="modal-cover">
        ...
        <div className="modal-header">
          <p className="modal-title">
            {L.translate('Base.Modals.Users.Withdraw.WithdrawSuccess.item1')}
          </p>
        </div>
      </div>
      <div className="modal-body">
        ...
        <div className="transfer-total-box">
          <div className="transfer-total">
            <p className="transfer-total__name">
              {L.translate('Base.Modals.Users.Withdraw.WithdrawSuccess.item2')}
            </p>
          ...
          <div className="transfer-total">
            <p className="transfer-total__name">
              {L.translate('Base.Modals.Users.Withdraw.WithdrawSuccess.item3')}
            </p>
            <div className="transfer-total__val">
        ...
        <div className="view-history">
          <Link
            ...
            onClick={closeModal}
          >
            {L.translate('Base.Modals.Users.Withdraw.WithdrawSuccess.item4')}
          </Link>
        </div>
      </div>
    </div>
