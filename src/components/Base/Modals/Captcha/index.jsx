...
import captchaBg from '../../../../styles/img/captcha-bg.png';
import captchaLogo1 from '../../../../styles/img/captcha-logo1.png';
import captchaLogo2 from '../../../../styles/img/captcha-logo2.png';
...
const Captcha = ({
  handleCaptcha,
  title = {
    platform: 'DafriXchange Pro',
    text: L.translate('Base.Modals.Captcha.item1'),
  },
  icon = {
    active: captchaLogo1,
  ...
  swipe = {
    ...
    text: L.translate('Base.Modals.Captcha.item2'),
  },
}) => {
