    ...
    <div className=" modal">
      ...
      <div className="modal-header">
        <p className="modal-title">
          {L.translate('Base.Modals.CancelAllOrders.item1')}
        </p>
      </div>
      <div className="modal-body">
        <div className="form-submit  form-submit--sb">
          <div className="form-submit__col">
            <button className="button " onClick={handleCancelAllOrders}>
              {L.translate('Base.Modals.CancelAllOrders.item2')}
            </button>
          </div>
          <div className="form-submit__col">
            <button className="button button--type2" onClick={closeModal}>
              {L.translate('Base.Modals.CancelAllOrders.item3')}
            </button>
          </div>
        </div>
      </div>
