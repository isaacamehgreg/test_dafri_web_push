...
import SortButton from '../../Withdraw/SupportedCurrency/SortButton';
import WithdrawCoinsItem from '../WithdrawCoinsItem';

const WithdrawCoinsList = ({ data }) => {
  const wallet = useSelector(walletSelector);
  const { isLoading, walletsList } = wallet;
  ...
  useMemo(
    () => sortingColumnTable({ sort, data: walletsList, setState: setWallets }),
    [sort, walletsList],
  );
  ...
  if (!walletsList || !walletsList.length)
    return (
      <p>{L.translate('Pages.Users.LockedToken.WithdrawCoinsList.item1')}</p>
    );
  ...
  const filterWallets = walletsList
    ...
    .map(currency => <WithdrawCoinsItem key={currency?.id} {...currency} />);
  ...
  return (
    <>
      <div className="transfer-panel transfer-panel--no-mt">
        <p className="item-title item-title--bigger">
          {L.translate('Pages.Users.LockedToken.WithdrawCoinsList.item2')}
        </p>
          ...
          <div className="field-wrap">
            <input
              ...
              placeholder={L.translate(
                'Pages.Users.LockedToken.WithdrawCoinsList.item8',
              )}
              value={search}
            ...
            <div className="tr">
              <div className="td">
                <div className="td-name td-name--type2">
                  {L.translate(
                    'Pages.Users.LockedToken.WithdrawCoinsList.item3',
                  )}
                  <SortButton
              ...
              <div className="td">
                <div className="td-name td-name--type2">
                  {L.translate(
                    'Pages.Users.LockedToken.WithdrawCoinsList.item4',
                  )}
              ...
              <div className="td">
                <div className="td-name td-name--type2">
                  {L.translate(
                    'Pages.Users.LockedToken.WithdrawCoinsList.item5',
                  )}
                  <SortButton
                    toggleSort={toggleSort}
                    sort={sort}
              ...
              <div className="td">
                <div className="td-name td-name--type2">
                  {L.translate(
                    'Pages.Users.LockedToken.WithdrawCoinsList.item6',
                  )}
                  <SortButton
                    toggleSort={toggleSort}
                    sort={sort}
          ...
          <div className="table-body">
            {filterWallets.length ? (
              ...
              <p style={{ padding: '20px 0', textAlign: 'center' }}>
                {L.translate('Pages.Users.LockedToken.WithdrawCoinsList.item7')}
              </p>
            )}
          </div>
        </div>
...
export default WithdrawCoinsList;
